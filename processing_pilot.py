...
if __name__ == "__main__":
    ...
    # Save the dictionary as a formatted JSON file in the main processed_files directory
    ...
    for subject_folder in master_folder.iterdir():
        if subject_folder.is_dir():
            ...
            # ------------------------------------------------------------------
            # STEP 1 & 2: CHECK DIRECTORY -> SKIP OR PREPROCESS
            # ------------------------------------------------------------------
            ...
            for condition in conditions_to_run:
                ...
                # Check if ALL expected files for this condition exist
                ...
                if all_exist:
                    ...
                    # Load each specific file directly into its correct sub-key
                    ...
                    # If even ONE file is missing, we must run the preprocessing pipeline for this condition
                    ...
                    with open(log_file_path, 'w') as json_file:
                        # cls=NumpyEncoder acts as a translator for all those np.int64 values!
